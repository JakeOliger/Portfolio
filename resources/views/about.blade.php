...
@section('title', 'About')
@section('meta_description', 'A glimpse into the life and times of Jake Oliger')
@section('meta_title', 'About Jake Oliger')

@section('content')
    <h2>About Me</h2>
    <div class="page-banner rappel"><p>Jake rappelling after a climb in El Potrero Chico, Mexico</p></div>
    ...
    <ul>
        <li>Andrew Robert's <span class="italic">Churchill: Walking With Destiny</span> because I wanted to learn about this man I'd heard so much about but knew so little. The book paints him in an unrealistically positive light, but it's chock full of fasinating facts and stories.</li>
        <li>C.S. Lewis's <span class="italic">The Problem of Pain</span> is about why there is evil and pain in a world created good by God. A very compelling read. Heavy stuff.</li>
        <li>Barbara Tuchman's <span class="italic">The Guns of August</span> is a brilliant and horrifying retelling of the outbreak of World War I and how we blundered our way into it.</li>
        <li>Robert Caro's <span class="italic">The Path to Power</span> is the beginning of a cursed series. You try explaining to people how a few thousand page series about Lyndon B. Johnson is so darn compelling. It's impossible. But it is!</li>
    </ul>
@endsection