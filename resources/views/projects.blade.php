...
@section('meta_description', 'A collection of projects that Jake has worked on either for work or for self-edification')
@section('meta_title', 'Jake Oliger\'s Projects')

@section('content')
    <h2>Projects</h2>
    <div class="page-banner chapel"><p>Jake playing guitar for a morning chapel at Camp Tecumseh</p></div>
    @include('partials.resume_notice')
    ...
    <p class="indented"><img class="project-thumb" src="{{ url('/images/issues2016.jpg') }}" alt="Issues 2016" title="Issues 2016"><a href="https://2016.jakeoliger.com">Issues 2016</a> was a quick 'n' dirty personal project from during the 2016 election primaries in which I toyed around with, primarily, creating a quiz to anonymize campaign statements made by candidates in an attempt to neutrally determine who an individual aligns most closely with on policy. This is a flawed project with an imperfect &mdash; and incomplete &mdash; execution. The main issue is probably how easy it is to tell who said what just based on the unique voice each candidate has, which shines through even in a text format. Some of them were also just sloppily anonymized, if anonymized at all. There were a lot of quotes to go through and my focus was admittedly more on getting the functionality working than having it look professional. Another issue is the quiz is quite long, so it took some convincing just to get people to try it out, haha.</p>
    <h3>GlobalOffensiveBot <span>&mdash; (2014-15)</span></h3>
    <p class="indented">This is a harder project to show off because its use-case is very specific and behind-the-scenes, but it is one of the larger projects I have ever worked on in terms of scale of the work. Despite the fact that I left the project years ago, it is still undergoing active development and is still used regularly by its primary target users: the moderators of reddit's Counter-Strike: Global Offensive community.</p>
    <p class="indented">The project, put quickly, is a combination of a Python bot and a webpanel running on a virtual private Linux server to aid in the running of that 600,000+ user community. The major features that I developed for it are as follows, broken down into two sections: the webpanel and the bot.</p>
    <h4 class="indented">Webpanel</h4>
    <ul class="indented">
    ...
    <p class="indented"><img class="project-thumb" src="{{ url('/images/steamtoolbox.jpg') }}" alt="SteamToolbox.com" title="SteamToolbox.com">This was my first large web project. It is not maintained and so is not as functional as it was at its peak, but it is still available <a href="https://steamtoolbox.com">here</a>. SteamToolbox is a website for displaying various statistics about your Steam profile, such as which games you play the most, who your oldest friends are, what the opportunity cost of the time spent playing games is, statistics specific to a few games, etc. It was pretty popular among my friends, but I never really made an effort to spread it wider than that. I wish I had. There are other sites like it, but I think mine had potential to be one of the best, with a little refining and promotion.</p>
    <p class="indented">The main functionality of this site is written in PHP and Javascript. The primary challenge was processing all the data from the Steam API in an efficient manner, storing things that could be stored and fetching things that couldn't be.</p>
    <h3>MCBasewars <span>&mdash; (2013)</span></h3>
    <p class="indented">This is an old plugin built for a Minecraft server system called Bukkit, which is what most people used at the time. My plugin replicated a Garry's Mod game mode called Basewars, where individuals set up bases wherein they would "print" in-game money and hoard it, using their money to invest in other schemes to create more money, allthewhile fending off marauders or marauding themselves. This project was built, as all Minecraft mods are, in Java. At the time it was one of the larger code sets I had ever created, being over 6,000 lines of code, if I remember correctly. Unfortunately, I've since lost the code. This was before I knew how to use things like Git or Subversion.</p>
    <p class="indented">This is a project I kind of built, <a href="https://dev.bukkit.org/projects/mcbasewars">published</a>, and forgot about. Over 250 server maintainers downloaded it and a comment was left in 2016 from someone making a suggestion, so it seems as though some people used it and enjoyed it.</p>
    <h3>Previous Work</h3>
    <p class="indented">I've been programming since around 2008 or 2009, but the projects from back then hardly demonstrate present ability <span class="italic">(nor can I find half of them because I didn't consistently use version control or host them)</span>, so they are not included here.</p>
@endsection